...
const size_t DispHolder::MAX_SIZE = 250000;
...
{
    // Don't pre-reserve MAX_SIZE — with the cap raised to 10M, that would
    // allocate 80MB of pointer slots up front. Let the vector grow naturally.
}
